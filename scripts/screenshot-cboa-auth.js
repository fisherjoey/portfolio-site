...
async function captureScreenshots() {
  ...
  // Portal pages to capture
  const pages = [
    { url: 'https://cboa.ca', name: '01-home', wait: 3000 },
    { url: 'https://cboa.ca/portal', name: '02-portal-dashboard', wait: 5000 },
    { url: 'https://cboa.ca/portal/schedule', name: '03-schedule', wait: 5000 },
    { url: 'https://cboa.ca/portal/profile', name: '04-profile', wait: 5000 },
    { url: 'https://cboa.ca/portal/members', name: '05-members', wait: 5000 },
    { url: 'https://cboa.ca/portal/admin', name: '06-admin', wait: 5000 },
  ];

  console.log('Capturing CBOA with auth...');
